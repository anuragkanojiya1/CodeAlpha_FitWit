...
//        }
        ...
        Surface(
            ...
            Box {
                AnimatedSignUp(modifier = Modifier
                    .size(500.dp, 400.dp)
                    .align(Alignment.Center)
                    // .scale(scaleX = 1.3f, scaleY = 1.6f)
                )
...
@Composable
fun AnimatedSignUp(modifier: Modifier = Modifier) {
...
@Composable
fun SignUpPreview(){
    SignUpScreen(navController = rememberNavController(), auth = FirebaseAuth.getInstance())
}